  ...
  services: [
    {
      id: 'srv-gps',
      name: 'GPS Navigation',
      description: 'Built-in navigation device with live traffic updates.',
      price: 8,
      category: 'Equipment',
    },
    {
      id: 'srv-seat',
      name: 'Child Seat',
      description: 'ECE R44/04 certified seat for 9m – 4y.',
      price: 6,
      category: 'Equipment',
    },
    {
      ...
      description: 'Zero excess insurance and roadside assistance.',
      price: 18,
      category: 'Protection',
    },
    {
      id: 'srv-wifi',
      name: 'In-Car Wi-Fi',
      description: 'Unlimited 4G hotspot for your rides.',
      price: 10,
